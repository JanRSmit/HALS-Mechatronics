...
The aluminium mounting bracket, shown in GTSP5212LB_4.jpg, is a crucial element, as this will hold the rotatingdrive assembly, its details covered in RotatingDrive folder.
...
## 3D models
For the 3D models, both a Fusion360 archive file and a STEP file is present for the 3D models of the endcap, weight-plateau and weight-bracket. The adjustable M8x24mm foot(screw) is also as simple 3D model present.
